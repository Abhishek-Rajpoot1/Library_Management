...
//             String id="1";
           DB1.DBConnect db=new DB1.DBConnect();
            ...
            if(db.rst.next())
            {
            out.println("<tr><td class=data> Book Id</td><td><input type=text name=id value='"+db.rst.getString(1)+"'></td></tr>");
            ...
            out.println("<tr><td class=data>Book Sem</td><td><input type=text name=sem value='"+db.rst.getString(4)+"'></td></tr>"); 
                ...
                out.println("Wrong Book Id  <a href=Update.jsp>Try again..</a>");
            }
